...
@click.command()
@click.option('--set', '-s', nargs=2, type=str, multiple=True)
@click.option('--unset', '-u', nargs=1, type=str, multiple=True)
@click.option('--add', '-a', nargs=2, type=str, multiple=True)
@click.option('--remove', '-r', nargs=2, type=str, multiple=True)
